...
const slideUpAnimationClasses =
  "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom data-[state=open]:zoom-in-100 data-[state=closed]:zoom-out-100";
